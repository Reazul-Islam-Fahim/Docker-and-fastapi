...
class Settings(BaseSettings):
    ...
    VERIFICATION_URL: str = "http://localhost:3000/verify-email?token={token}"
    
    FORGOT_PASSWORD_URL: str = "http://localhost:3000/auth/forgot-password?email={email}"
    
    PASSWORD_RESET_URL: str = "http://localhost:3000/auth/reset-password?token={token}"
